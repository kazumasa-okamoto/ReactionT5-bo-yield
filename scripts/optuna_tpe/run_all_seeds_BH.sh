#!/bin/bash
# Run Optuna TPE experiments with multiple seeds for Buchwald-Hartwig dataset

# Configuration
DATA_PATH="../../data/Buchwald-Hartwig/Dreher_and_Doyle_reaction.csv"
DATASET_NAME="BH"
N_TRIALS=100
N_STARTUP_TRIALS=10
N_EI_CANDIDATES=24
...
echo "=========================================="
echo "Dataset: $DATASET_NAME (Buchwald-Hartwig)"
